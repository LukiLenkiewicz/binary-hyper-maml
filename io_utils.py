...
def parse_args(script):
    ...
    parser.add_argument('--method', default='baseline', choices=['baseline', 'baseline++', 'DKT', 'protonet', 'matchingnet', 'relationnet', 'relationnet_softmax', 'maml', 'maml_approx', 'hyper_maml','bayes_hmaml', 'binary_maml', 'vbh_maml'] + list(hypernet_types.keys()),
