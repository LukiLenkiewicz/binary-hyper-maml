...
export NEPTUNE_API_TOKEN="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS"
...
python train_vbh.py --method vbh_maml --dataset cross_char --num_classes 4112 \
  ...
  --hn_tn_depth 2 --hn_tn_hidden_size 256 --hn_mask_type hard --hn_train_lr 0.01